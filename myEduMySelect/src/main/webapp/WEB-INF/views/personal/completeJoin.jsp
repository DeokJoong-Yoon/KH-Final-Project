...
<link rel="stylesheet" type="text/css"
	href="/resources/include/personal/css/completeSignUp.css">
		...
		<div class="container">
			<div class="row">
				<div
					...
					<button type="button" id="userLoginBtn" onclick="window.location.href='/personal/login'">개인 회원 로그인 하러 가기</button>
				</div>
