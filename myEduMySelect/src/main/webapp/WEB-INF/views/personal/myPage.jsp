...
<form:form id="updateForm" action="/personalUpdate" modelAttribute="personalLoginVO" method="POST" name="personalMyPage">
    ...
    <div class="sign-form">
        ...
        <div class="form-group">
            ...
            <form:input path="personalPasswd"  type="password" id="personalPasswd" name="personalPasswd" class="form-control" style="width: 250px;"/>
        </div>
        <br />
        ...
        <a href="/matching/boardList" class="btn btn-primary">매칭게시판에서 내가 쓴 글 목록 보기</a> 
        
        <a href="/personalMatchingList" class="btn btn-primary">매칭 게시판 아예 새로운 매핑</a>
    </div>
</form:form>
