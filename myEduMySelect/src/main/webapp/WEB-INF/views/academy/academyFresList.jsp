...
<body>
  ...
  <header id="header" class="fixed-top ">
						        ...
						        <c:when test="${not empty freeBoardList}">
						            <c:forEach var="free" items="${freeBoardList}" varStatus="status">
						                <tr data-num="${free.commonNo}">
						                    ...
						                    <td class="goDetail">${free.academyId}</td>
	...
	<script src="/resources/include/academy/freeBoardacademyView.js"></script>
	<script>
	$(function() {
		...
		if (word != "") {
			...
			if ($("#search").val() != 'commonContent') {
				...
				else if ($("#search").val() == 'academyId') value = "#list tr td.name";
